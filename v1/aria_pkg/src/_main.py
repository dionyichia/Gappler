...
from services.grounding_sam import GroundingSAM
from services.feature_matcher import FeatureMatcher
...
class AriaObjectDetectionPipeline:
    ...
    def __init__(self):
        ...
        # Initialize ROS node
        rospy.init_node(self.ros_config.node_name, anonymous=True)
