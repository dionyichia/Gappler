...
class Robot:
    ...
    def display_bricks(self):
        ...
        size_and_colors = [(brick[1], brick[2]) for brick in bricks]
    ...
    def display_collision_free_bricks(self):
        ...
        print(
            f"Detected all collision-free bricks in Robot View:\n {size_and_colors} \n"
        )
        return True
    ...
    def grab_brick_by_center_point(self, target_center, tolerance=50):
        ...
        if closest_brick_idx is None:
            ...
            return False
        print(
            f"closest brick: brick {closest_brick_idx} with \n {bricks[closest_brick_idx]}"
        )
    ...
    def get_3d_bricks_and_image(self):
        ...
        if score > 0.994:
            ...
            bricks, _ = self.robot.get_brick_poses(
                registered_bricks, color_image, depth_image
            )
