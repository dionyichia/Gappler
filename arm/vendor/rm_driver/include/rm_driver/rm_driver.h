...
public:
    ...
    void Arm_Set_Gripper_Pick_On_Callback(const rm_ros_interfaces::msg::Gripperpick::SharedPtr msg); // Continuous force-controlled gripping
    void Arm_Set_Gripper_Pick_Callback(const rm_ros_interfaces::msg::Gripperpick::SharedPtr msg);    // Force-controlled gripping
    void Arm_Set_Gripper_Position_Callback(const rm_ros_interfaces::msg::Gripperset::SharedPtr msg); // Move to fixed position
    /*********************************灵巧手回调函数******************************/
